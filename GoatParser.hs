...
myReserved
    = ["call", "do", "else", "fi", "float", "if", "od", "ref", "then", "val", "while", "begin", "bool", "end", "false", "int", "proc", "read", "true", "write"]
myOpnames 
    = ["+", "-", "*", ":=", "||", "&&", "!", "=", "!=", "<", "<=", ">", ">=", "/"] --there are two negative signs representing two different tokens, how to handle?
